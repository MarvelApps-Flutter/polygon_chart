library polygon_chart;

import 'package:flutter/material.dart';
import 'dart:math' show pi, cos, sin;
import 'dart:math' as math;

import 'package:polygon_chart/constant/colors.dart';
...
class ChartPagePainter extends CustomPainter {
  final List<double> ticks;
  final List<String> features;
  final List<List<num>> data;
  final bool reverseAxis;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var tickLabels = reverseAxis ? ticks : ticks.reversed.toList();
  ...
  @override
  bool shouldRepaint(ChartPagePainter oldDelegate) {
